...
class MaxAvgTransactionsAlert(AbstractJob):
    ...
    def __init__(self, threshold, average_stats_pqueue: PriorityQueue, callback, interval):
    ...
    def _iteration(self):
        while not self.__avg_stats_pqueue.empty():
            time, avg = self.__avg_stats_pqueue.get()
