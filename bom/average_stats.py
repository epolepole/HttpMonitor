...
class AverageStats:
    def __init__(self, avg_time_frame):
        self.__trx_avg = Queue()
        self.__avg_time_frame = avg_time_frame
        self.__current_second = None
        self._trx_per_sec = defaultdict(int)

    def get(self):
        return self.__trx_avg.get()

    def empty(self):
        return self.__trx_avg.empty()
    ...
    def __generate_average(self, last_second):
        ...
        self.__trx_avg.put((sum_cumulative / self.__avg_time_frame, last_second))
